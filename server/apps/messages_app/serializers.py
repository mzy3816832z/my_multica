...
class MessageListItemSerializer(serializers.Serializer):
    ...
    related_apartment_id = serializers.IntegerField(help_text='关联房源 ID', allow_null=True)
    related_apartment_name = serializers.SerializerMethodField(help_text='关联房源名称（已删除或系统通知时为 null）')
